...
while True:
    ...
    #InfoPage
    elif mainpage_page == 4:
        while True:
            print("\n\n--------------- Info ---------------\n")
            print("Futbol Takım Yönetimm Oyununa Hoşgeldiniz .\nBu oyunda amaç Ligde 38 hafta sonunda birinci olmaktır .Her takımın sahip olduğu bir takım gücü ve ve her zaman değiştirebileceğiniz bir takım stratejisi vardir")
            print("- - - - - - - - - - - - -\n")
            print("Takım Güçleri : Takım gücü 0 ile 100 arasında seçilmiştir .Oyun başlamadan önce ayarlar kısmından değiştirebilirsiniz ")
            print("- - - - - - - - - - - - -\n")
            print("Takım Stratejileri Özellikleri ; ")
            print("Agresif        : Oyundaki en ofansif stratejidir .Takımı ileride oynamaya ve rakibe baskı yaparak gol atma şansını arttırma hedefini artırmaya dayanan bir oyun statejisidir Lakin ileride oynamak gol şansını artırdığı gibi gol yeme ihtimalini artırmaktadır ")
            print("- - - - - - ")
            print("Yarı Agesif    : Agresif oyun statejisine sahipse de daha yumuşatılmış halidir ")
            print("- - - - - - ")            
            print("Normal         : Oyunda dengeli bir stratejidir .Gol atma ve gol yeme ihtimali takım gücüne dayanır")
            print("- - - - - - ")            
            print("Yarı defansif  : Defansif oyun statejisine sahipse de daha yumuşatılmış halidir ")
            print("- - - - - - ")            
            print("Defansif       : Oyundaki en defansif ve gol yeme ihtimalinin en az olduğu oyun stratejisidir her ne kadar gol yeme ihtimali düşse de aynı zamanda gol atma ihtimali de düşer.\n\n")
            break
